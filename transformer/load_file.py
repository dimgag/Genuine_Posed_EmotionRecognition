...
class CnnTransformer(nn.Module):
    ...
    def _load_pretrain_resnet50vgg(self, ckpt):
        ...
        with open(ckpt, 'rb') as f:
            obj = f.read()
        checkpoint_org = {key: torch.from_numpy(arr) for key, arr in pickle.loads(obj, encoding='latin1').items()}
        # try:
...
CnnTransformer(num_patch=1, embed_dim=512, output_dim=2, num_heads=8, dropout=0.1, cnn_ckpt='/Users/dim__gag/Desktop/resnet50_ft_weight/resnet50_ft_weight.pkl')